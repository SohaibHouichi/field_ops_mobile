...
CustomersResponse _$CustomersResponseFromJson(
  ...
  assetsList: (json['assetsList'] as List<dynamic>?)
      ?.map((e) => AssetEmbeddedResponse.fromJson(e as Map<String, dynamic>))
      .toList(),
  serviceRequestsList: (json['serviceRequestsList'] as List<dynamic>?)
      ?.map(
        (e) =>
            ServiceRequestEmbeddedResponse.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
