...
import 'package:field_ops/features/tenants/presentation/widgets/drop_down_registration_widget.dart';
...
class CustomerSignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => GetIt.I<TenantCubit>()..fetchTenants(),
                              ...
                              Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DropDownRegistrationWidget(
                                      value: selectedTenant,
                                      onChanged: (name) =>
                                          setState(() => selectedTenant = name),
                                      validator: (v) =>
